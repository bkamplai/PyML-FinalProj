...
# mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225] (resnet50 values)
...
"""
def train(model):
    # Training data folder and csv file paths.
    train_csv = '../dataset/train_csv.csv'
    train_images = '../dataset/Train_Alphabet'
...
"""
def test():
    # Testing data folder and csv file paths.
    test_csv = '../dataset/test_csv.csv'
    test_images = '../dataset/Test_Alphabet'
